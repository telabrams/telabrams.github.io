...
jQuery(document).ready(function() {
    ...
    jQuery('.question').on('click', function () {
        jQuery('.question_bottom', this).toggleClass('display_block animated fadeIn');
        jQuery('.question_show,.question_less', this).toggleClass('display');
    });
    ...
    jQuery('.arrow_next').on('click', function () {
        ...
        jQuery('.slider_screen,.zoom_screen').css('background-image', slider_arrow[++counter_slider]);
    ...
    /*список слайдов*/
    var items_first = jQuery(".item_slider_list_first").find('.carusel_item');
    /*один слайд*/
    var slides_first = jQuery('.item_slider_list_first').children('.carusel_item');
    /*количество слайдов*/
    var slide_width_first = items_first.outerWidth();
    /*длина одного слайда*/
    ...
    /*список слайдов*/
    var items_mini = jQuery(".slider_film_list").find('.slider_film_item');
    /*один слайд*/
    var slides_mini = jQuery('.slider_film_list').children('.slider_film_item');
    /*количество слайдов*/
    var slide_width_mini = items_mini.outerWidth() + 40;
    /*длина одного слайда*/
    ...
    if (jQuery(window).width() > '1060') {
        ...
        jQuery(".slider_screen").click(function () {
            jQuery(".zoom_popup_wrapper").fadeIn(500);
            jQuery(".zoom_photo").toggleClass('display_block animated fadeInRight');

            jQuery(document).mouseup(function (e) {
                var popup_zoom = jQuery(".zoom_photo");
                if (!jQuery('.slider_screen').is(e.target) && !popup_zoom.is(e.target) && popup_zoom.has(e.target).length == 0) {
                    jQuery(".zoom_photo").removeClass('display_block animated fadeInRight');
                    jQuery(".zoom_popup_wrapper").fadeOut(500);
                }
            });
        });
    }
